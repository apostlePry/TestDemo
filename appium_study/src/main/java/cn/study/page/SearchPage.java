...
public class SearchPage extends BasePage {
    ...
    public SearchPage search(String keyWord){
        MobileElement searchInputText = this.getElement(By.id("com.xueqiu.android:id/search_input_text"));
        searchInputText.clear();
        searchInputText.sendKeys(keyWord);
        return this;
    }
    ...
    public List<String> getNameList(){
        ...
        this.getElements(By.id("com.xueqiu.android:id/name")).forEach(mobileElement -> {
            nameList.add(mobileElement.getText());
        });
        return nameList;
    }
    ...
    public Double getPrice(){
        this.getElement(By.xpath("//*[@text = 'BABA']")).click();
    ...
    public SearchPage next(){
        try {
            MobileElement tvLeft = this.getElement(By.id("tv_left"));
            tvLeft.click();
            return this;
        } catch (Exception e) {
            return this;
